  ...
  useEffect(() => {
    if (gl) {
      ...
      const VSHADER_SOURCE = `
        ...
        uniform vec4 u_Translation; // 平移量
        void main() {
      ...
      const u_Translation = gl.getUniformLocation(gl.program, 'u_Translation') // 获取平移变量位置
      gl.uniform4f(u_Translation, Tx, Ty, Tz, 0.0) // 给平移变量赋值
